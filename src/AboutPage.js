...
const AboutPage = () => {
  return (
    <div>
      <h2>About Pet Friends</h2>
        <p> 🏡🐾 Bringing Families and Furry Friends Together 🐾🏡 </p>
        <p>Once upon a time, in the charming town of Pawington, a group of passionate animal 
          ...
          warmth, and wagging tails.<p/>


        <p>In the early days, Pet Friends started as a modest pet adoption center, 
          ...
          of compassion and camaraderie among pet enthusiasts. </p>

        <p>As the years unfolded, so did the evolution of Pet Friends. 
          ...
          were determined to make the process as seamless and enjoyable as possible.</p>

        <p>In 2015, Pet Friends introduced a groundbreaking user-friendly interface, 
          ...
          pets more personalized and heartfelt.</p>

        <p>The community of Pet Friends grew stronger with each passing year. 
          ...
          lovers from all corners of the country.</p>

        <p>In 2020, a significant milestone was reached as Pet Friends expanded its 
          ...
          bond between humans and animals. The founders' vision had blossomed into a 
          genuine community built on the principles of love, understanding, and the joy 
          that comes from having a furry friend by your side. And so, the story of 
          Pet Friends continues to unfold, with countless tales of wagging tails, 
          purring companions, and families finding their perfect match. As we look 
          towards the future, the founders remain committed to their initial vision 
          to make the world a better place, one paw at a time. The legacy of 
          Pet Friends lives on, a testament to the enduring power of love and the 
          profound connections forged between families and their beloved furry friends.</p>
        <p>🏡🐾🏡🐾🏡</p>
      </p>
    </div>
  );
